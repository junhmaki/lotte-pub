...
gulp.task('imagemin', () => {
    return new Promise(resolve => {
        gulp
            .src([PATH.ASSETS.IMAGES + '/**/*.{gif,jpg,png,svg,pdf,cur,webp,mp4}', PATH.ASSETS.IMAGES + '/*.{gif,jpg,png,svg,pdf,cur,webp,mp4}'])
...
gulp.task('videoin', () => {
    return new Promise(resolve => {
        gulp
            .src([PATH.ASSETS.VIDEO + '/**/*.{mp4, mov}', PATH.ASSETS.VIDEO + '/*.{mp4, mov}'])
...
gulp.task('watch', () => {
    return new Promise(resolve => {
        ...
        gulp.watch(PATH.ASSETS.IMAGES + "/**/*.{gif,jpg,png,svg,cur,webp,mp4}", gulp.series(['imagemin']));
        gulp.watch(PATH.ASSETS.VIDEO + "/**/*.{mp4, mov}", gulp.series(['videoin']));
        resolve();
    });
});
